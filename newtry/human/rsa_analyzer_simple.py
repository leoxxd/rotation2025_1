...
def main():
    ...
    if rsa_results:
        ...
        print(f"\n📁 生成的文件:")
        print(f"  - rsa_results_simple/all_rsa_results.mat")
        print(f"  - rsa_results_simple/all_rsa_results.csv")
        print(f"  - rsa_results_simple/roi_lh_1/ (按ROI分类)")
        print(f"  - rsa_results_simple/roi_lh_2/ (按ROI分类)")
        print(f"  - rsa_results_simple/roi_rh_1/ (按ROI分类)")
        print(f"  - rsa_results_simple/subject_s1/ (按被试分类)")
        print(f"  - rsa_results_simple/subject_s2/ (按被试分类)")
        print(f"  - rsa_results_simple/rsa_analysis.png (总体分析图)")
        print(f"  - rsa_results_simple/rsa_heatmap.png (热力图)")
